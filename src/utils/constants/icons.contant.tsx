export const ICONS = {
  settings: (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" width="16px" height="16px">
      <path
        fill="none"
        stroke="#000000"
        strokeWidth="2"
      ...
      />
      <circle fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="25" cy="25" r="7" />
    </svg>
  )
};
